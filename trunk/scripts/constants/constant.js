...
angular.module('carrot')
  .constant('searchOptions', {
	province: [
		...
		category: [
			{name: '不限', choose: true},
			{type: 1, name: '前端', choose: false},
			{type: 2, name: '后端', choose: false},
			{type: 3, name: '移动', choose: false},
			{type: 4, name: '测试', choose: false},
			{type: 5, name: '运维', choose: false},
			{type: 6, name: '高端职位', choose: false},
			{type: 7, name: '产品经理', choose: false},
			{type: 8, name: '高端职位', choose: false},
			{type: 9, name: '视觉设计', choose: false},
			{type: 10, name: '交互设计', choose: false},
			{type: 11, name: '高端职位', choose: false}
		],
		subCategory: [
			{
				name: "前端",
				data: [{name: '前端', choose: true},
					{type: 1, name: 'web前端', choose: false},
					{type: 2, name: 'flash', choose: false},
					{type: 3, name: 'javascript', choose: false},
					{type: 4, name: 'html5', choose: false},
					{type: 5, name: '前端开发其他', choose: false}]
			},
			{
				name: "后端",
				data: [{name: '后端', choose: true},
					{type: 1, name: 'java', choose: false},
					{type: 2, name: 'php', choose: false},
					{type: 3, name: 'c++', choose: false},
					{type: 4, name: 'ruby', choose: false},
					{type: 5, name: 'node.js', choose: false},
					{type: 6, name: 'python', choose: false},
					{type: 7, name: '后端开发其他', choose: false}
				]
			},
			{
				name: "移动",
				data: [{name: '移动', choose: true},
					{type: 1, name: 'html5', choose: false},
					{type: 2, name: 'Android', choose: false},
					{type: 3, name: 'IOS', choose: false},
					{type: 4, name: 'WP', choose: false},
					{type: 5, name: '移动开发其他', choose: false}
				]
			},
			{
				name: "测试",
				data: [{name: '测试', choose: true},
					{type: 1, name: '测试工程师', choose: false},
					{type: 2, name: '性能测试', choose: false},
					{type: 3, name: '功能测试', choose: false},
					{type: 4, name: '测试其他', choose: false}
				]
			},
			{
				name: "运维",
				data: [{name: '运维', choose: true},
					{type: 1, name: '运维工程师', choose: false},
					{type: 2, name: '网络工程师', choose: false},
					{type: 3, name: '系统工程师', choose: false},
					{type: 4, name: '运维其他', choose: false}
				]
			},
			{
				name: "高端职位",
				data: [{name: '高端职位', choose: true},
					{type: 1, name: '技术总监', choose: false},
					{type: 2, name: '技术经理', choose: false},
					{type: 3, name: '架构师', choose: false},
					{type: 4, name: 'CTO', choose: false},
					{type: 5, name: '高端技术职位其他', choose: false}
				]
			},
			{
				name: "产品经理",
				data: [{name: '产品经理', choose: true},
					{type: 1, name: '产品经理', choose: false},
					{type: 2, name: '移动产品经理', choose: false},
					{type: 3, name: '网页产品经理', choose: false},
					{type: 4, name: '电商产品经理', choose: false},
					{type: 5, name: '游戏策划', choose: false}
				]
			},
			{
				name: "高端职位",
				data: [{name: '高端职位', choose: true},
					{type: 1, name: '产品总监', choose: false},
					{type: 2, name: '游戏制作人', choose: false}
				]
			},
			{
				name: "视觉设计",
				data: [{name: '视觉设计', choose: true},
					{type: 1, name: 'UI设计师', choose: false},
					{type: 2, name: '平面设计师', choose: false},
					{type: 3, name: '网页设计师', choose: false},
					{type: 3, name: 'app设计师', choose: false}
				]
			},
			{
				name: "交互设计",
				data: [{name: '交互设计', choose: true},
					{type: 1, name: '网页交互设计师', choose: false},
					{type: 2, name: '交互设计师', choose: false},
				]
			},
			{
				name: "高端职位",
				data: [{name: '高端职位', choose: true},
					{type: 1, name: '设计总监', choose: false},
					{type: 2, name: '视觉设计主管', choose: false},
					{type: 3, name: '交互设计主管', choose: false}
				]
			}
		],
	industry: [
	...
	updateAt: [
		{name: '不限', choose: true},
		{type: 0, name: '今天', choose: false},
		{type: 1, name: '3天内', choose: false},
		{type: 2, name: '7天内', choose: false}
	],
	financing: [
		{name: '不限', choose: true},
